...
#define APPNAME L"Vouks X264 Plugin"
#define PLUGIN_AUDIO_SAMPLE_RATE 96000
#define PLUGIN_AUDIO_FRAME_SIZE 1024
...
typedef struct X264
{
	...
	std::vector<SimpleParam> const profiles
	{
		...
		{ (csSDK_int32)X264::Profile::High422, "High 4:2:2" },
		{ (csSDK_int32)X264::Profile::High444, "High 4:4:4" }
	};
...
void convertCharIntoUTF16(const char* inputString, prUTF16Char* destination);
